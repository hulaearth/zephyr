...
if(DEFINED ram_load_rom_region_path)
  dt_prop(ram_load_rom_region PATH ${ram_load_rom_region_path} PROPERTY "zephyr,memory-region")
  if(NOT DEFINED ram_load_rom_region)
    message(FATAL_ERROR "RAM-load ROM region must define zephyr,memory-region")
  endif()
  zephyr_string(SANITIZE ram_load_rom_region ${ram_load_rom_region})
  dt_reg_addr(ram_load_rom_addr PATH ${ram_load_rom_region_path})
endif()
...
elseif(DEFINED ram_load_rom_region)
  zephyr_linker_group(NAME ROM_REGION VMA ${ram_load_rom_region} LMA ${ram_load_rom_region})
  set(rom_start ${ram_load_rom_addr})
else()
